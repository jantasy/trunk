...
public class ProgressWheel extends View {
    ...
    private int barColor = 0xFF1196F0;
    private int rimColor = 0xFFC9C9C9;
    ...
    private void setupBounds(int layout_width, int layout_height) {
        ...
        if (!fillRadius) {
            ...
            circleBounds = new RectF(paddingLeft + barWidth / 2,
                    paddingTop + barWidth / 2,
                    layout_width - paddingRight - barWidth / 2,
                    layout_height - paddingBottom - barWidth / 2);
        }
    }
