 ...
 */
public class PatrolPointUnSelectedHolder extends YjtBaseHolder<PatrolPoint> {

    public TextView mTvPatrolPointName;
    public CheckBox mCbSelected;

    public PatrolPointUnSelectedHolder(Context context) {
        super(context);
    }

    @Override
    public View initView() {
        mConvertView = View.inflate(mContext, R.layout.patrol_point_unselected_item, null);
