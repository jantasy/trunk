...
public class PullToRefreshListView extends ListView implements OnScrollListener {
    ...
    //箭头图片
    private static  int REFRESHICON = R.drawable.nfc_goicon; 
    ...
    private void init(Context context) {
		...
		mRefreshView = (View) mInflater.inflate(R.layout.nfc_pull_to_refresh_header, this, false);//(R.layout.nfc_pull_to_refresh_header, null);
        ...
        if (mCurrentScrollState == SCROLL_STATE_TOUCH_SCROLL   //如果是接触滚动状态,并且不是正在刷新的状态
            ...
            if (firstVisibleItem == 0) {    //如果显示出来了第一个列表项
                ...
                if ((mRefreshView.getBottom() >= mRefreshViewHeight + 20
                    ...
                    mRefreshViewText.setText(R.string.nfc_pull_to_refresh_release_label);
                    mRefreshViewImage.clearAnimation();
                    ...
                    mRefreshViewText.setText(R.string.nfc_pull_to_refresh_pull_label);
                    if (mRefreshState != TAP_TO_REFRESH) {
                        mRefreshViewImage.clearAnimation();
    ...
    public void prepareForRefresh() {
       ...
       mRefreshViewText.setText(R.string.nfc_pull_to_refresh_refreshing_label);
